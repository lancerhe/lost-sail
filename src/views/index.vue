<template>
  <div id="hitter">
    <header>
      ...
      <span>S6 迷航模拟器更新中</span>
      <span></span>
    </header>

    <div style="margin-top: 20%">
      <p style="padding-bottom: 20px; font-weight: 600; color: #ff2d51">小样 还会猜新版本地址呢</p>
      <p style="padding-bottom: 20px; font-weight: 600; color: #ff2d51">S5还没结束 就想着S6呢 夯技师压力很大呢</p>
